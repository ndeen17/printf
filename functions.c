 ...
 * @flags:  this calculates the active string
 * @width: this shows the width
 * @precision: to show the specification
 * @size: this shows the size specifier
...
/**
 * print_percent - this shows  a percent sign
 * @types: This List all of the arguments
 * @buffer: this is a buffer array to handle the print
 * @flags:  it calculates the active flags
 * @width: this gets the width
 * @precision: this gets the specification
 * @size: this is a size specifier
 * Return: it returns the number of characters printe
 */
...
/**
 * print_binary - shows an unsigned number
 * @types: This List all of the arguments
 * @buffer: this is a buffer array to handle the print
 * @flags:  it calculates the active flags
 * @width: this gets the width
